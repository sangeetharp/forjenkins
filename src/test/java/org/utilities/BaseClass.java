...
//65
	...
	public static String getData(int rowNumber,int cellNumber) throws IOException {
		File f=new File("C:\\Users\\praba\\FrameworkCucumber\\target\\Testdata\\Fb.xlsx");
...
driver.manage().timeouts().implicitlyWait(i,TimeUnit.SECONDS);
	...
	public static void toexplicitwait(long l ) throws InterruptedException {
		WebDriverWait w= new WebDriverWait(driver,l);
	}
	
public static void launchIncognito() {
	WebDriverManager.chromedriver().setup();
...
driver = new ChromeDriver(o);
	...
	public static void toViewJavascriptExecutor(WebElement w) {
		JavascriptExecutor js=(JavascriptExecutor)driver;
		  js.executeScript("arguments[0].scrollIntoView(true)", w);
	}				
	
	public static void toclickWithJse(WebElement w) {
		
		JavascriptExecutor js=(JavascriptExecutor)driver;
	      js.executeScript("arguments[0].click()", w);
	}		
	public static void toEnterWithRobot() throws AWTException {
		 Robot r=new Robot();
